...
<table align = "center">
<tr><td>账号:</td><td><input type="text" name="shareaccount_id"  id="u" onblur="ma()"/><span id="d1"></span></td></tr>
<tr><td>密码：</td><td><input type="text" name="shareaccount_pwd"  id="u" /><span id="d2"></span></td></tr>
<tr><td>手机号：</td><td><input type="text" name="shareaccount_num"  id="u" onblur="mb()"/><span id="d3"></span></td></tr>
<tr><td>银行卡：</td><td><input type="text" name="shareaccount_card"  id="u"/><span id="d4"></span></td></tr>
<tr><td>开户公司：</td><td><input type="text" name="shareaccount_company"  id="u" /><span id="d5"></span></td></tr>
<tr></tr>
<tr><td colspan="3" align="center"><input type="submit" value="添加信息" onclick="return clicked();"></td></tr>
</table>
</form>
</body>
</html>